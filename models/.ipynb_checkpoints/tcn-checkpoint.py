...
# tcn_options = {
#         "num_layers": 4,#4
#         "kernel_size": [3,5,7],#[3,5,7]
#         "dropout": 0.2,
#         "dwpw": False,
#         "width_mult": 1,#1
#     }
# from torchsummary import summary
# model = MultibranchTemporalConvNet(512,[768,768,768,768],tcn_options)
# # #print (model)
# # model =MultibranchTemporalBlock(512,768,[3,5,7],1,2,[4,8,12])
# # print (model)
# summary(model, input_size=[(512,384)], batch_size=8, device="cpu")
